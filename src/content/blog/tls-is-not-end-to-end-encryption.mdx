...
The SDK's `sealed-sender` module blanks sender fields on the identified-delivery path. It reduces linkability and does not provide anonymity. [Metadata and limits](https://docs.open-e2ee.dev/learn/limits-and-metadata) documents the published research and the limits.
